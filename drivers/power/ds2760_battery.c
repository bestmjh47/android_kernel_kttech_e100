 ...
 *
 * Copyright 짤 2007 Anton Vorontsov
...
struct ds2760_device_info {
	...
	int voltage_uV;			/* units of 쨉V */
	int current_raw;		/* units of 0.625 mA */
	int current_uA;			/* units of 쨉A */
	int accum_current_raw;		/* units of 0.25 mAh */
	int accum_current_uAh;		/* units of 쨉Ah */
	int temp_raw;			/* units of 0.125 째C */
	int temp_C;			/* units of 0.1 째C */
	int rated_capacity;		/* units of 쨉Ah */
	int rem_capacity;		/* percentage */
	int full_active_uAh;		/* units of 쨉Ah */
	int empty_uAh;			/* units of 쨉Ah */
...
/* array is level at temps 0째C, 10째C, 20째C, 30째C, 40째C
 * temp is in Celsius */
...
static int ds2760_battery_read_status(struct ds2760_device_info *di)
{
	 ...
	 * class reports in units of 쨉A, so convert by multiplying by 625. */
	di->current_raw =
	...
	/* DS2760 reports temperature in signed units of 0.125째C, but the
	 * battery class reports in units of 1/10 째C, so we convert by
	...
	di->rated_capacity *= 1000; /* convert to 쨉Ah */
	...
	di->full_active_uAh *= 1000; /* convert to 쨉Ah */
	...
	di->empty_uAh *= 1000; /* convert to 쨉Ah */
