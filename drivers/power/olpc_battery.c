 ...
 *
 *	Copyright 짤 2006-2010  David Woodhouse <dwmw2@infradead.org>
 *
...
#define EC_BAT_ACR	0x12	/* int16_t,	*6250/15,    쨉Ah  */
#define EC_BAT_TEMP	0x13	/* uint16_t,	*100/256,   째C  */
#define EC_AMB_TEMP	0x14	/* uint16_t,	*100/256,   째C  */
